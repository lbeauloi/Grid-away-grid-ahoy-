# Grid away, grid ahoy!
The objective is to create a section on a website. The objective is to practice and use the grids
...
![](./assets/deCapture.PNG)


## Project Link 
[Grid away, grid ahoy!](https://lbeauloi.github.io/Grid-away-grid-ahoy-/)
## Badges
